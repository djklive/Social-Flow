...
try {
    ...
    error_log("Erreur notifications CM: " . $e->getMessage());
    $cm = null;
    $notifications = [];
    $unread_count = 0;
}
    ...
    <div class="fixed inset-y-0 left-0 z-50 w-64 bg-white shadow-lg sidebar-transition" id="sidebar">
        ...
        <nav class="mt-8">
            ...
            <div class="px-4 space-y-2">
                ...
                <a href="notifications.php" class="flex items-center px-4 py-2 text-sm font-medium text-white bg-green-100 rounded-lg">
                                    ...
                                    <div class="flex items-center space-x-2 ml-4">
                                        <?php if (!$notification['is_read']): ?>
                                            <form method="POST" class="inline">
                                                ...
                                                <button type="submit" class="text-green-600 hover:text-green-700 text-sm" title="Marquer comme lu">
