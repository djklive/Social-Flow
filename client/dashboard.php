    ...
    <div class="fixed inset-y-0 left-0 z-50 w-64 bg-blue-100 shadow-lg sidebar-transition" id="sidebar">
        ...
        <nav class="mt-8">
            ...
            <div class="px-4 space-y-2">
                ...
                <a href="content_approval.php" class="flex items-center px-4 py-2 text-sm font-medium text-blue-800 hover:bg-blue-200 rounded-lg">
        ...
        <header class="bg-blue-200 shadow-sm border-b border-blue-300">
            <div class="flex items-center justify-between px-6 py-4">
                <div>
                    ...
                    <p class="text-sm text-blue-700">Bienvenue, <?php echo htmlspecialchars($client['first_name']); ?> !</p>
                </div>
        ...
        <main class="p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                ...
                <div class="bg-white rounded-lg shadow-sm p-6 card-hover">
                    <div class="flex items-center">
                        <div class="p-3 rounded-full bg-blue-100">
                            <i class="fas fa-heart text-blue-800 text-xl"></i>
                        </div>
                        <div class="ml-4">
                        ...
                        <?php if ($subscription): ?>
                            <div class="space-y-3">
                                ...
                                <div class="flex justify-between">
                                    ...
                                    <span class="font-medium"><?php echo number_format($subscription['price']); ?> FCFA</span>
                                </div>
                                <div class="flex justify-between">
                            ...
                            <a href="subscription.php" class="mt-4 block w-full text-center bg-blue-800 text-white py-2 rounded-lg hover:bg-blue-900 transition duration-300">
                                Gérer l'abonnement
                            </a>
                        <?php else: ?>
                            <div class="text-center py-4">
                                ...
                                <a href="subscription.php" class="mt-2 block w-full text-center bg-blue-800 text-white py-2 rounded-lg hover:bg-blue-900 transition duration-300">
                ...
                <div class="lg:col-span-2">
                    <div class="bg-white rounded-lg shadow-sm p-6">
                        <div class="flex items-center justify-between mb-6">
                            ...
                            <a href="publications.php" class="text-blue-800 hover:text-blue-900 text-sm font-medium">
