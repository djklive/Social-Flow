...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        error_log("Erreur paramètres client: " . $e->getMessage());
    }
}
                ...
                <div class="bg-white rounded-lg shadow-sm p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <p class="text-sm text-gray-900"><?php echo ucfirst($client['role']); ?></p>
                        </div>
                        
                        <div>
                            <h3 class="text-sm font-medium text-gray-500 mb-2">Membre depuis</h3>
                            <p class="text-sm text-gray-900"><?php echo format_date_fr($client['created_at'], 'd/m/Y'); ?></p>
                        </div>
                        
                        <div>
                            <h3 class="text-sm font-medium text-gray-500 mb-2">Dernière connexion</h3>
                            <p class="text-sm text-gray-900">
                                <?php echo $client['last_login'] ? format_date_fr($client['last_login'], 'd/m/Y H:i') : 'Jamais'; ?>
                            </p>
                        </div>
                        
                        <div>
                            <h3 class="text-sm font-medium text-gray-500 mb-2">Statut</h3>
                            <span class="px-2 py-1 text-xs rounded-full <?php echo $client['status'] === 'active' ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'; ?>">
